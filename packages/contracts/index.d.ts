...
export type DocumentErrorCode = "aborted" | "deadline-exceeded" | "fetch-failed" | "integrity-failed" | "invalid-source" | "invalid-text" | "job-conflict" | "lease-lost" | "malformed" | "output-too-large" | "processing-failed" | "render-failed" | "resource-limit" | "search-failed" | "sink-failed" | "source-changed" | "too-large" | "too-many-cells" | "too-many-pages" | "too-many-slides" | "unsupported-runtime" | "worker-failed";
