...
export declare const ingestionRuntimeCapabilities: Readonly<{ durableCancellation: true; durableJobs: true; idempotentSinks: true; leaseRecovery: true; nativeRenderModels: false; outputBudgets: true; verifiedStreamingReads: true }>;
